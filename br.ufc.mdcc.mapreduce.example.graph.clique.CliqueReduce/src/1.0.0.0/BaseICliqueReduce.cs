...
namespace br.ufc.mdcc.mapreduce.example.graph.clique.CliqueReduce { 
	public interface BaseICliqueReduce : BaseIReduceFunction<IInteger, IKVPair<IInteger, IIterator<IInteger>>, IKVPair<IInteger, IKVPair<IInteger, IIterator<IInteger>>>>, IComputationKind {
